...
public class Form {
	...
	public static void caricaUsers(ArrayList<Persona> persone) throws IOException {
		FileReader fr = null;
		String s;
	...
	public static void registrazione(ArrayList<Persona> persone) throws IOException {
		Scanner sc = new Scanner(System.in);
		String user = "";
		String password = "";
		String confPassword = "";
	...
	public static void login(ArrayList<Persona> persone) throws IOException {
		Scanner sc = new Scanner(System.in);
		String user = "";
		String password = "";
	...
	public static void scriviFile(ArrayList<Persona> persone, String user, String password) {
